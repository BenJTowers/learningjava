public class IntegerLinkedList {
	...
	private boolean isnegative(IntegerNode n){
		if (n == null) {
			...
			boolean idk = isnegative(n.next);
			return (n.getData() < 0) && idk;
		}
	...
	private boolean issorted(IntegerNode n){
		if (n == null) {
			return true;
		} else if(n.next != null){
			boolean idk = issorted(n.next);
			IntegerNode b = n.next;
			return (n.getData() <= b.getData()) && idk;
		}else{
			return true;
		}
